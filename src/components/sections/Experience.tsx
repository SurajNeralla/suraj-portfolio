...
const experiences = [
  {
    ...
    duration: 'Aug 15, 2026 – Sep 15, 2026',
    location: 'Remote',
    type: 'Internship',
    color: '#10B981',
    responsibilities: [
      'Completed a 1-Month AICTE & ICAC Approved internship program in Cyber Security.',
      'Gained practical knowledge in vulnerability assessment, penetration testing, and ethical hacking.',
      'Implemented network security concepts and explored various cybersecurity tools and methodologies.'
    ],
    skills: ['Cyber Security', 'Ethical Hacking', 'Penetration Testing', 'Network Security', 'Vulnerability Assessment'],
  },
  {
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
                  <div className="flex items-start gap-4">
                    ...
                    <motion.div
                      ...
                      style={{
                        background: `${experience.color}26`, // 15% opacity roughly
                        border: `1px solid ${experience.color}4D`, // 30% opacity roughly
                      }}
                    >
                      <Briefcase size={26} style={{ color: experience.color }} />
                    </motion.div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2 text-sm text-white/50 font-mono">
                      <Calendar size={14} style={{ color: experience.color }} />
                      {experience.duration}
                    </div>
                    <div className="flex items-center gap-2 text-sm text-white/50 font-mono">
                  ...
                  <div className="space-y-3">
                    {experience.responsibilities.map((resp, i) => (
                      <motion.div
                        ...
                        transition={{ duration: 0.5, delay: 0.3 + index * 0.2 + i * 0.1 }}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {experience.skills.map((skill, i) => (
                      <motion.span
                        ...
                        transition={{ duration: 0.4, delay: 0.6 + index * 0.2 + i * 0.06, type: 'spring', stiffness: 400 }}
